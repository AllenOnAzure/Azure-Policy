...
variable "use_custom_identity" {
  description = "Whether to use custom user-assigned identity"
  type        = bool
  default     = true
}

# Add these variable declarations to your VARIABLES section
variable "log_analytics_workspace_name" {
  description = "Name of the Log Analytics Workspace"
  type        = string
  default     = "amalinuxdeployment"
}

variable "dcr_name" {
  description = "Name of the Data Collection Rule"
  type        = string
  default     = "AMA-Linux-DCR"
}
##################RESOURCES########################################
